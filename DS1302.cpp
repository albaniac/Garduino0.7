 ...
 * Reloj_DS1302_3.cpp
 *
 * Created: 16/06/2018 10:31:29 p. m.
 * Author : jose
 */ 
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
DS1302::DS1302(uint8_t inSCLK, uint8_t inIO, uint8_t inC_E)   {                          //|    |
  SCLK = inSCLK;                                                                                         //|    |
  IO = inIO;                                                                                             //|    |
  C_E = inC_E;                                                                                           //|    |
...
void DS1302::_DS1302_start( void )  {                                                            //|    |
  ...
  Pullup_off_DDRD(DS1302_CE_PIN);
  
  //pinMode( DS1302_CE_PIN, OUTPUT );                                                                      //|    |
  TogglePIND(Config_as_output_DDRD(DS1302_CE_PIN));
                                                                                                         //|    |
  //digitalWrite( DS1302_SCLK_PIN, LOW ); // default, clock low
  Pullup_off_DDRD(DS1302_SCLK_PIN);
  //pinMode( DS1302_SCLK_PIN, OUTPUT );                                                                    //|    |
  TogglePIND(Config_as_output_DDRD(DS1302_SCLK_PIN));  
                                                                                                         //|    |
  //pinMode( DS1302_IO_PIN, OUTPUT );                                                                      //|    |
  TogglePIND(Config_as_output_DDRD(DS1302_IO_PIN));                                                                                                       //|    |
  //digitalWrite( DS1302_CE_PIN, HIGH );  
  Pullup_on_DDRD(uint8_t PORT);      // start the session 
  _delay_ms( 4 );                    // tCC = 4us                                       //|    |
}                                                        //|    |
                                                                                                         //|    |
//=======================================================================================================//|    |
...
//  function, the SCLK is already high.                                                                  //|    |
  for( i = 0; i <= 7; i++ )  {                                                                           //|    |
	...
	Pullup_on_DDRD(DS1302_SCLK_PIN);                                                                //|    |
    _delay_ms( 1) ;                                                                              //|    |
                                                                                                         //|    |
    // Clock down, data is ready after some time.                                                        //|    |
    //digitalWrite( DS1302_SCLK_PIN, LOW );
	Pullup_off_DDRD(DS1302_SCLK_PIN);
    _delay_ms( 1 ); // tCL=1000ns, tCDD=800ns
                                                                                                         //|    |
    // read bit, and set it in place in 'data' variable 
	//--------------------TO-DO-----------------------
    //bitWrite( data, i, digitalRead( DS1302_IO_PIN ) );   
	bitWrite(data, i, ReadHigh( DS1302_IO_PIN));                                                                                                 //|    |
  }                                                                                                      //|    |
  return( data );                                                                                        //|    |
}                                                //|    |
                                                                                                         //|    |
...
void DS1302::_DS1302_togglewrite( uint8_t data, uint8_t release)  {                              //|    |
  ...
  for( i = 0; i <= 7; i++ )  {                                                                           //|    |
	...
	//----------------TO-DO
    _delay_ms( 1 );                                     // tDC = 200ns                           //|    |
                                                                                                         //|    |
    // clock up, data is read by DS1302                                                                  //|    |
    //digitalWrite( DS1302_SCLK_PIN, HIGH );
	
	Pullup_on_DDRD(DS1302_SCLK_PIN);                                                               //|    |
    _delay_ms( 1 );                                     // tCH = 1000ns, tCDH = 800ns            //|    |
                                                                                                         //|    |
...
//  release the I/O-line at this moment, and that could cause a shortcut spike on the I/O-line.          //|    |
    if( release && i == 7 )  {                                                                           //|    |
	   ...
	   Config_as_input_DDRD(DS1302_IO_PIN);
    } 
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302::setDS1302Time(uint8_t seconds, uint8_t minutes, uint8_t hours, uint8_t dayofweek,   //|    |
